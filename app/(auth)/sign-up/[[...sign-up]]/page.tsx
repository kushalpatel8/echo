    ...
    <main style={{
      ...
      <div style={{ position: 'relative', width: '100%', maxWidth: '440px' }}>
        <div style={{
          ...
          background: `radial-gradient(circle, rgba(16,185,129,${isDark ? '0.08' : '0.04'}) 0%, transparent 70%)`,
          pointerEvents: 'none',
        }} />
        <div style={{ textAlign: 'center', marginBottom: '2rem', position: 'relative' }}>
          ...
          <h1 style={{ fontSize: '1.5rem', fontWeight: '800', color: 'var(--echo-text)' }}>Join ECHO</h1>
